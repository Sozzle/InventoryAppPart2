...
public class EditActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mIncreaseButton = (Button) findViewById(R.id.increase_quantity);
        Button mDecreaseButton = (Button) findViewById(R.id.decrease_quantity);
        ...
        mIncreaseButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(quantity)) {
                    Toast.makeText(EditActivity.this, R.string.edit_quantity_field_cannot_be_empty, Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(quantity)) {
                    ...
                    if ((givenQuantity - 1) >= 0) {
                        ...
                        Toast.makeText(EditActivity.this, R.string.edit_quantity_cannot_be_less_then_0, Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });

        //setting up the phone button in the edit activity to call the supplier

        final Button mPhoneCallSupplierPhoneNumberButton = (Button) findViewById(R.id.call_supplier_phone_number_button);


        mPhoneCallSupplierPhoneNumberButton.setOnClickListener(new View.OnClickListener() {
